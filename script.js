...
const essayQuestions = [
    " Trong giờ Toán, thầy Hùng phát hiện An đang nói chuyện riêng. Dù đã được nhắc nhở nhẹ nhàng lần một, An vẫn tiếp tục quay xuống bàn dưới tán gẫu. Mất bình tĩnh, thầy Hùng quát lớn: \"Cậu ra ngay khỏi lớp cho tôi!\" và kiên quyết đuổi An ra ngoài. Câu hỏi: Thầy Hùng đã vi phạm NGHIÊM TRỌNG NHẤT nguyên tắc gì trong giao tiếp sư phạm? Nếu là thầy Hùng, anh/chị sẽ xử lý tình huống này thế nào?",
    "  Giờ Hóa học, cô Mai gọi Bình lên bảng giải bài tập cũ. Dù cô đã gợi ý nhiều lần, Bình vẫn lúng túng không làm được. Quá thất vọng, cô Mai gõ thước xuống bàn và nói trước lớp: \"Có bài dễ thế này mà cũng không hiểu, đúng thật là nước đổ đầu vịt\". Lời nói của cô Mai vi phạm nghiêm trọng nhất nguyên tắc giao tiếp sư phạm nào? Anh/chị hãy đưa ra cách giải quyết sư phạm phù hợp với nguyên tắc giao tiếp sư phạm.",
    "Dạo gần đây, Nam thường xuyên đi học muộn vào tiết đầu. Sáng nay, khi Nam vừa bước vào cửa, mồ hôi nhễ nhại, cô Lan (giáo viên chủ nhiệm) không để Nam giải thích mà phạt em đứng ở góc lớp suốt tiết học và ghi tên vào sổ đầu bài. Thực tế, hôm nay trên đường đi Nam đã nán lại để giúp một em nhỏ bị ngã xe. Câu hỏi: Phân tích nguyên tắc giao tiếp sư phạm bị vi phạm trong tình huống trên. Cách xử lý phù hợp của anh/chị là gì?. "
"Minh là một học sinh cá biệt và thường xuyên đi học muộn môn Toán của thầy Tuấn. Hôm nay, khi Minh vừa bước vào cửa lớp (muộn 30p), thầy Tuấn dừng giảng và cười khẩy nói trước cả lớp :\"Chào giám đốc, ngài bận trăm công nghìn việc quá nên nay mới có thời gian đến dự giờ lớp ta cơ à ?\". Cả lớp cười ồ lên. Minh đỏ mặt, quăng cặp xuống bàn và gục xuống không thèm lấy sách vở ra học. Lời nói của thầy Tuấn mang lại hậu quả tâm lý gì cho học sinh? Thầy đã vi phạm nguyên tắc giao tiếp sư phạm nào nghiêm trọng nhất? Hãy đề xuất cách ứng xử và giải quyết sự việc của em Minh."];
